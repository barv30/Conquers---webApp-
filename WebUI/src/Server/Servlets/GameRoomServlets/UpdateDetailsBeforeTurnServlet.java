...
@WebServlet(name = "UpdateDetailsBeforeTurnServlet", urlPatterns = {"/pages/GameRoom/UpdateDetailsBeforeTurn"})
public class UpdateDetailsBeforeTurnServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(currentPlayer.getNumberOfTerritories()>0) {
            gameEngine.calculateTuringsForPlayer(currentPlayer);
            gameEngine.calculateLostPowerAndTerritories(currentPlayer);
        }
        out.println(gson.toJson(currentPlayer));
    }
