...
@WebServlet(name = "MaintainArmyServlet", urlPatterns = {"/pages/GameRoom/maintainArmy"})
public class MaintainArmyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isMaintainSuccess = gameEngine.maintainArmy(territory);
        ResultOfRequest result = new ResultOfRequest("", false);
        if(isMaintainSuccess){
            result.setMessage("maintain");
        } else {
            result.setMessage("no_maintain");
