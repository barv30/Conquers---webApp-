...
@WebServlet(name = "GameTerritoryInfoServlet", urlPatterns = {"/pages/GameRoom/gameTerritory"})
public class GameTerritoryInfoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println(gson.toJson(territory));
