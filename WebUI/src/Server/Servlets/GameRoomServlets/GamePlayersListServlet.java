...
@WebServlet(name = "GamePlayersListServlet", urlPatterns = {"/pages/GameRoom/gamePlayers"})
public class GamePlayersListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println(gson.toJson(gamesManager.findGameController((String)(request.getSession(false).getAttribute("gameName"))).getPlayerListOfGame()));
    }
