...
@WebServlet(name = "BuyArmyServlet", urlPatterns = {"/pages/GameRoom/buyArmy"})
public class BuyArmyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        gameEngine.buyArmy(unitsToBuy1,territory,gameEngine.getCurrentPlayer(),rowNumber,colNumber);
